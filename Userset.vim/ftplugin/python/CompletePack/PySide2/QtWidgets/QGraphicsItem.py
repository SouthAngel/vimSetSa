...
class QGraphicsItem(__Shiboken.Object):
    ...
    def sceneMatrix(self, *args, **kwargs): # real signature unknown
        pass
    ...
    ItemContainsChildrenInShape = None # (!) real value is ''
    ...
    ItemRotationChange = None # (!) real value is ''
    ItemRotationHasChanged = None # (!) real value is ''
    ItemScaleChange = None # (!) real value is ''
    ItemScaleHasChanged = None # (!) real value is ''
    ...
    ItemStopsClickFocusPropagation = None # (!) real value is ''
    ItemStopsFocusHandling = None # (!) real value is ''
    ...
    ItemTransformOriginPointChange = None # (!) real value is ''
    ItemTransformOriginPointHasChanged = None # (!) real value is ''
