...
class QStyleOptionToolButton(QStyleOptionComplex):
    ...
    toolButtonStyle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    Arrow = None # (!) real value is ''
    HasMenu = None # (!) real value is ''
    Menu = None # (!) real value is ''
    MenuButtonPopup = None # (!) real value is ''
    None = None # (!) real value is ''
    PopupDelay = None # (!) real value is ''
    StyleOptionType = None # (!) real value is ''
    StyleOptionVersion = None # (!) real value is ''
    ToolButtonFeature = None # (!) real value is ''
    ToolButtonFeatures = None # (!) real value is ''
