...
class QTreeView(QAbstractItemView):
    ...
    def resetIndentation(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setTreePosition(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def treePosition(self, *args, **kwargs): # real signature unknown
        pass
