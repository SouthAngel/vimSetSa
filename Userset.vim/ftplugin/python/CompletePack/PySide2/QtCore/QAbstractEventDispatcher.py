...
class QAbstractEventDispatcher(QObject):
    ...
    def registerEventNotifier(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def remainingTime(self, *args, **kwargs): # real signature unknown
        pass

    def startingUp(self, *args, **kwargs): # real signature unknown
        pass

    def unregisterEventNotifier(self, *args, **kwargs): # real signature unknown
        pass
