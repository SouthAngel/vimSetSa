...
class QDir(__Shiboken.Object):
    ...
    def listSeparator(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def removeRecursively(self, *args, **kwargs): # real signature unknown
        pass
    ...
    NoDot = None # (!) real value is ''
    NoDotAndDotDot = None # (!) real value is ''
    NoDotDot = None # (!) real value is ''
