...
class QProcess(QIODevice):
    ...
    def inputChannelMode(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def nativeArguments(self, *args, **kwargs): # real signature unknown
        pass

    def nullDevice(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def processId(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setInputChannelMode(self, *args, **kwargs): # real signature unknown
        pass

    def setNativeArguments(self, *args, **kwargs): # real signature unknown
        pass
    ...
    Crashed = None # (!) real value is ''
    CrashExit = None # (!) real value is ''
    ExitStatus = None # (!) real value is ''
    FailedToStart = None # (!) real value is ''
    ForwardedChannels = None # (!) real value is ''
    ForwardedErrorChannel = None # (!) real value is ''
    ForwardedInputChannel = None # (!) real value is ''
    ForwardedOutputChannel = None # (!) real value is ''
    InputChannelMode = None # (!) real value is ''
    ManagedInputChannel = None # (!) real value is ''
    MergedChannels = None # (!) real value is ''
    NormalExit = None # (!) real value is ''
    ...
    ReadError = None # (!) real value is ''
    Running = None # (!) real value is ''
    SeparateChannels = None # (!) real value is ''
    StandardError = None # (!) real value is ''
    StandardOutput = None # (!) real value is ''
    Starting = None # (!) real value is ''
    staticMetaObject = None # (!) real value is ''
    Timedout = None # (!) real value is ''
    UnknownError = None # (!) real value is ''
    WriteError = None # (!) real value is ''
