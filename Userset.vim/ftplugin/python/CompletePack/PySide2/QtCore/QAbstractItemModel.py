...
class QAbstractItemModel(QObject):
    ...
    def canDropMimeData(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def moveColumn(self, *args, **kwargs): # real signature unknown
        pass

    def moveColumns(self, *args, **kwargs): # real signature unknown
        pass

    def moveRow(self, *args, **kwargs): # real signature unknown
        pass

    def moveRows(self, *args, **kwargs): # real signature unknown
        pass
    ...
    HorizontalSortHint = None # (!) real value is ''
    LayoutChangeHint = None # (!) real value is ''
    NoLayoutChangeHint = None # (!) real value is ''
    staticMetaObject = None # (!) real value is ''
    VerticalSortHint = None # (!) real value is ''
