...
class QPainterPathStroker(__Shiboken.Object):
    # no doc
    def capStyle(self, *args, **kwargs): # real signature unknown
        pass

    def createStroke(self, *args, **kwargs): # real signature unknown
        pass

    def curveThreshold(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def setCurveThreshold(self, *args, **kwargs): # real signature unknown
        pass
